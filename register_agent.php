...
<section class="section-lg">
    <div class="main-grid" align="center" style="margin-top:50px ">
        <div class="col-md-5 col-md-offset-4">
            <form id="userRegi" method="post" action="action/user_agent.php" enctype="multipart/form-data">
                ...
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">NID Front Image</span>
                    </div>
                    <input type="file" class="form-control" placeholder="" name="photo1" required>
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">NID Back Image</span>
                    </div>
                    <input type="file" class="form-control" placeholder="" name="photo2" required>
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
