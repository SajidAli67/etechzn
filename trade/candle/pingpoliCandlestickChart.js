...
function pingpoliCandlestickChart( canvasElementID )
{
    ...
    this.canvas.style.backgroundColor = "#000205";
    this.context.font = '16px sans-serif';
    this.gridColor = "#290101";
    this.gridTextColor = "#aaaaaa";
    this.mouseHoverBackgroundColor = "#023b3d";
    this.mouseHoverTextColor = "#f2fafa";
    this.greenColor = "#057a5b";
    this.redColor = "#cc0000";
    this.greenHoverColor = "#057a5b";
